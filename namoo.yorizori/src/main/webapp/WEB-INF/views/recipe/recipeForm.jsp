					...
					<form class="row g-3" action="#" method="post"
						...
						<div class="col-md-6">
							<label for="writer_name" class="form-label">등록자</label> <input
								type="text" class="form-control" id="writer_name" value="한식매니아"
								disabled>
						</div>
						<div class="col-md-6">
						...
						<div class="col-12" id="recipe_sequence">
							<label for="seq_num1" class="form-label">조리절차</label> <input
								type="text" class="form-control" id="seq_num1"> <input
								type="text" class="form-control" id="seq_num2"> <input
								type="text" class="form-control" id="seq_num3">

						</div>
						<input type="button" class="btn btn-info btn-sm" value="추가" id="add">
						<div class="col-12">
							<label for="img_file_name" class="form-label">조리사진</label> <input
								type="file" class="form-control" id="img_file_name">
						</div>
